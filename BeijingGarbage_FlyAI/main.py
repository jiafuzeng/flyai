...
class Main(FlyAI):
    ...
    def train(self):
        ...
        warmup_epoch = 5
        trainDataSize = len(image_path_list) - len(image_path_list) // 100
        ...
        kf = KFold(n_splits=200,random_state=233,shuffle=True)
        for epoch,(train_indix,val_indix) in enumerate(kf.split(df['image_path'].values)):
            ...
            batch_steps = len(train_image_path_list) // args.BATCH + 1
            ...
            for i in range(batch_steps):
                ...
                temp_x, temp_y = get_batch_data(train_image_path_list, train_label_list,args.BATCH,args.input_size)
